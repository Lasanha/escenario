...
font_title = DRAW_SETTINGS.get(
    'FONT_TITLE', os.path.join(settings.BASE_DIR, 'ROADWAY_.TTF'))
font_text = DRAW_SETTINGS.get(
    'FONT_TEXT', os.path.join(settings.BASE_DIR, 'kharon.ttf'))
font_titulo = ImageFont.truetype(font_title,
                                 int(os.environ.get('F_TITULO', 34)))
font_faltam = ImageFont.truetype(font_title,
                                 int(os.environ.get('F_FALTAM', 34)))
font_descricao = ImageFont.truetype(font_text,
